package pers.dingpingchuan.commons.heavy.utils.file;
...
public class FileUtils {
     ...
     * @return
     */
    public static List<String> readLinesContent(String filePath, int beginLineNumber, int endLineNumber) throws Exception {
        List<String> listContent = new ArrayList<>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filePath = "/"+getConTextPath() + "/src/main/resources/file/grammarCase.txt";
        readLinesContent(filePath, 0, 1258);
    }
